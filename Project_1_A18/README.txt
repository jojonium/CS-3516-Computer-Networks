...
To run the client, use the command './http_client [-p] server_url port_num', where server_url is
the address you want to connect to and port_num is the port you want to connect on. Include the
-p switch to print out the RTT for accessing the URL.

To run the server, use the command './http_server port_num', where port_num is the port you want
